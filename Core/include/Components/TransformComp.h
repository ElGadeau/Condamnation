...
namespace Components
{
	...
	public:
		...
		void SetChild(const Core::GameObject& p_child) { m_child = std::shared_ptr<TransformComp>(p_child.GetComponent<TransformComp>()); }
		...
		void SetParent(const Core::GameObject& p_parent) { m_parent = std::shared_ptr<TransformComp>(p_parent.GetComponent<TransformComp>()); }
