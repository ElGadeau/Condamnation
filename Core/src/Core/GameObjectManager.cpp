...
Core::GameObjectManager::GameObjectManager(Core::MeshManager& p_modelManager)
{
    ...
    DirLight->GetComponent<Components::TransformComp>()->m_transform->Translate(glm::vec3(0, 200, 200));
    ...
    Gear->GetComponent<Components::TransformComp>()->m_transform->Translate({ -2, 5, 0 });
    Torus->GetComponent<Components::TransformComp>()->m_transform->Translate({ 2, 5, 0 });
